...
function mouseover(d, i) {
  ...
  tooltip.style('display', 'block')
    ...
    .style('transform', util.tooltipPosition(w, margin, r(d[valAccessor]) * Math.cos((Math.PI * 2 / dataLength) * i - Math.PI / 2), r(d[valAccessor]) * Math.sin((Math.PI * 2 / dataLength) * i - Math.PI / 2)))
